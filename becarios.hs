...
--Precondición: El nivel debe existir en el equipo.
becariosNivelN 0        e  = Registro (nombre e) Fin
becariosNivelN nivel    e  = Registro (nombre e) (becariosNivelN (nivel-1) (siguienteNivel e )) 


siguienteNivel ::  Equipo ->  Equipo
siguienteNivel       (Becario n)         = (Becario n)
siguienteNivel (Investigador n e1 e2 e3) =  e1


nombre:: Equipo -> Nombre 
nombre (Becario n) = n 
nombre (Investigador n _ _ _) = n 
